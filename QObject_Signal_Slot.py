...
""" QObject and all subclasses of QObject (direct or indirect)
	have their copy constructor and assignment operator disabled.
"""
...
print("meta-object: ", father.metaObject().className())
